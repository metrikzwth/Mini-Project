...
export interface Order {
  ...
  patientId: string;
  patientName: string;
  items: { medicineId: string; medicineName: string; quantity: number; price: number }[];
  total: number;
...
export const initialMedicines: Medicine[] = [
  {
    ...
    instructions: {
      ...
      precautions: ['Do not exceed 4g in 24 hours', 'Consult doctor if symptoms persist']
    }
  },
  {
    id: '2',
  ...
  },
  {
    ...
    instructions: {
      ...
      precautions: ['Do not crush or chew', 'Long-term use requires monitoring']
    }
  },
  {
    id: '4',
  ...
  },
  {
    ...
    instructions: {
      ...
      precautions: ['Do not exceed recommended dose', 'May interact with certain medications']
    }
  }
];
...
export const initialUsers: User[] = [
  { id: 'p1', email: 'patient@test.com', password: 'patient123', name: 'John Patient', role: 'patient', phone: '555-0101', address: '123 Health St, Medical City' },
  { id: 'p2', email: 'jane@test.com', password: 'jane123', name: 'Jane Doe', role: 'patient', phone: '555-0102', address: '456 Care Ave, Wellness Town' },
  { id: 'd1', email: 'doctor@test.com', password: 'doctor123', name: 'Dr. Sarah Johnson', role: 'doctor' },
  { id: 'd2', email: 'drchen@test.com', password: 'chen123', name: 'Dr. Michael Chen', role: 'doctor' },
  { id: 'a1', email: 'admin@test.com', password: 'admin123', name: 'Admin User', role: 'admin' }
];

// Chatbot knowledge base
export const chatbotKnowledge = {
  medicines: initialMedicines.reduce((acc, med) => {
  ...
  disclaimer: "⚠️ This chatbot provides general information only and does not replace professional medical advice. Always consult with your healthcare provider for personalized medical guidance."
};
